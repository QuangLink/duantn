    ...
    return (
        <Box cursor="pointer">
            ...
            >
                ...
                <Box>
                    <Image src={`https://cdn.tgdd.vn/2022/06/banner/TraGop390-97-390x97-2-390x97-2.png`} alt={""} mb="6%" />
                    <Image src={`https://cdn.tgdd.vn/2022/07/banner/TV-Trung-bay-390x97-1.png`} alt={""} />
                </Box>
            </Box>
        </Box>
    );
