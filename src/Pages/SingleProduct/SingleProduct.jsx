                      ...
                      >
                        ...
                        >
                          ...
                          <ListItem>
                            ...
                            hình ảnh phù hợp nội dung Dải màu rộng Nano Color
                            Giảm độ trễ chơi game Auto Low Latency Mode
                            (ALLM)HDR Dynamic Tone MappingHDR10 ProHLGNâng cấp
                            hình ảnh AI Picture Pro 4KNâng cấp độ phân giải 4K
                            AI Upscaling Tương thích bộ mã hóa Video decoder
                            (VP9, AV1)Tương thích HEVC{" "}
                            <span style={{ color: "#2871c4" }}>Read T&C</span>
                          </ListItem>
                        </UnorderedList>
                        <Heading size="sm" marginBottom={3}>
                        ...
                        >
                          <ListItem>
                            {singleData.prodName} có thiết kế Airslim không viền
                            3 cạnh sang trọng và tinh tế. Mang lại tổng thể cho
                            không gian trưng bày thêm điểm nhấn vô cùng ấn
                            tượng.
                            <br />
                            Màn hình {singleData.prodName} cùng chân đế vững
                            ...
                            <>
                              <Text fontSize="lg" marginBottom={3}>
                                ...
                                {singleData.prodPriceSale &&
                                  singleData.prodPriceSale.toLocaleString(
                                    "vi-VN",
                                    {
                                      style: "currency",
                                      currency: "VND",
