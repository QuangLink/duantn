...
const Forgot = () => {
   ...
   function RegexEmail(emailInputBox) {
    ...
    //   emailInputBox.focus;
           ...
           toast(' 🦄 Chúng tôi vừa gửi cho bạn email hướng dẫn đặt lại mật khẩu vào địa chỉ cho bạn', {
            position: "top-center",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
                ...
                <form className="login100-form validate-form">
                    ...
                    <form action="custommer.html">
                        <div className="wrap-input100 validate-input"
                            ...
                            <input className="input100" type="text" placeholder="Nhập email" name="emailInput"
                                id="emailInput" value="" />
                    ...
                    <div className="text-center p-t-70 txt2">
                        ...
                        {/* <script type="text/javascript">document.write(new Date().getFullYear());</script> */}
                         <a
                            className="txt2" href="https://www.facebook.com/nguyenvuduyhoai.2003/"> Code bởi Hoài </a>
                    </div>
                </form>
            </div>
        </div>
