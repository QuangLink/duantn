  ...
  if (isLargerThan1100) {
    return (
      <Box backgroundColor='#4a90e2' >
        ...
        <Flex className="flex-container" px="25%">
          <Link to="/">
            <Box>
          ...
          <Box>
            ...
            <Box bg={'#fff'} width="744px" height="auto" position={'fixed'} marginTop={5} borderRadius={15} >
              {results.slice(0, 5).map((results, id) => {
                return (
                  ...
                  // </Box>
                  <Link to={`/${results.prodType}/${results.prodID}`} >
